...
class SignalGeneratorApp(ctk.CTk):
    ...
    def _compute_and_plot_task(self):
        ...
        try:
            ...
            self.logger.info("Cálculo do sinal concluído com sucesso")
    ...
    def _update_plots(self):
        ...
        try:
            ...
            self.logger.info("Gráficos atualizados com sucesso")
        except Exception as e:
    ...
    def _adjust_initial_view(self):
        ...
        try:
            ...
            self.logger.warning(f"Erro ao ajustar visualização inicial: {str(e)}")
    ...
    def update_analysis_panels(self):
        ...
        try:
            ...
            self.logger.info("Painéis de análise atualizados com sucesso")
        except Exception as e:

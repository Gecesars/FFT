...
class SignalGeneratorApp(ctk.CTk):
    def __init__(self):
        ...
        tools_menu.add_command(label="Importar Forma de Onda (WAV)", command=self.import_wav)
    ...
    def _build_analysis_panels(self):
        ...
        self.time_analysis_results = {
            ...
            'crest_factor': tk.StringVar(value="---"),
            'zero_crossing': tk.StringVar(value="---"),
            'frequency': tk.StringVar(value="---"),
            'duty_cycle': tk.StringVar(value="---"),
            'peak_to_rms': tk.StringVar(value="---"),
            'kurtosis': tk.StringVar(value="---"),
            'skewness': tk.StringVar(value="---")
        }
        ...
        self.freq_analysis_results = {
            ...
            'fund_amp': tk.StringVar(value="---"),
            'thd': tk.StringVar(value="---"),
            'snr': tk.StringVar(value="---"),
            'sfdr': tk.StringVar(value="---"),
            'bandwidth': tk.StringVar(value="---"),
            'mod_index': tk.StringVar(value="---"),
            'harmonics': tk.StringVar(value="---"),
            'noise_floor': tk.StringVar(value="---"),
            'peak_freq': tk.StringVar(value="---")
        }
    ...
    def update_analysis_panels(self):
        ...
        try:
            ...
            if len(Y) > 0:
                ...
                self.freq_analysis_results['snr'].set(snr)
                self.freq_analysis_results['noise_floor'].set(noise_floor)
                ...
                self.freq_analysis_results['bandwidth'].set(bandwidth)
                ...
                if self.mod_am.get():
                    ...
                    if fundamental_amp > 0:
                        ...
                        if fundamental_amp > 0:
                            ...
                            mod_index = f"{mod_index_val:.1f}%"
                self.freq_analysis_results['mod_index'].set(mod_index)
                ...
                self.freq_analysis_results['peak_freq'].set(peak_freq)

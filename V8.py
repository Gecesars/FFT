...
class SignalGeneratorApp(ctk.CTk):
    ...
    def _build_status_bar(self):
        # Se já existir, remove para evitar duplicatas
        if hasattr(self, 'status_bar'):
            self.status_bar.pack_forget()

        # Cria a barra de status diretamente em self (root)
        ...
        # empacota AO FIM do __init__, após todos os outros .pack()
    ...
    def _on_mouse_motion(self, event):
        ...
        # Atualiza posição conforme tipo de linha
        # axvline → get_xdata / set_xdata
        # axhline → get_ydata / set_ydata
    ...
    def add_marker(self, kind):
        ...
        # — Verifica se clique está dentro do eixo visível
        ...
        # — Desativa temporariamente o autoscale
